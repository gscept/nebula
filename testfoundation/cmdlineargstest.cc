...
CmdLineArgsTest::Run()
{
    ...
    VERIFY(posixArgs.GetFloat4("-color") == float4(1.0f, 2.0f, 3.0f, 1.0f));
    ...
    VERIFY(winArgs.GetFloat4("-pos") == float4(1.03f, 4.53f, 10.2f, 1.0));
    VERIFY(winArgs.GetFloat4("-color") == float4(1.0f, 2.0f, 3.0f, 1.0f));
}
