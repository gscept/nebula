    ...
    static auto parseBody = [&](const PhysicsResource::BodyT& body) 
        {
            ...
            for (auto const& shape : body.shapes)
            {
                ...
                case ColliderType_Sphere:
                {
                    ...
                    AddCollider(geometry, material, shape->transform, "Sphere", collider->name, bodyInfo, tag, entry);
                }
                break;
                case ColliderType_Cube:
                {
                    ...
                    AddCollider(geometry, material, shape->transform, "Cube", collider->name, bodyInfo, tag, entry);
                }
                break;
                case ColliderType_Plane:
                {
                    ...
                    AddCollider(geometry, material, shape->transform, "Plane", collider->name, bodyInfo, tag, entry);
                }
                break;
                case ColliderType_Capsule:
                {
                    ...
                    AddCollider(geometry, material, shape->transform, "Capsule", collider->name, bodyInfo, tag, entry);
                }
                break;
                case ColliderType_Mesh:
                {
                    AddMeshColliders(collider->data.AsMeshCollider(), shape->transform, collider->name, material, tag, entry, bodyInfo);
                    /*
                ...
                {
                    AddHeightField(collider->data.AsHeightFieldCollider(), shape->transform, collider->name, material, tag, entry, bodyInfo);
                }
                break;
                default:
