    ...
    public static class Mathf
    {
        ...
        */
        ...
        /** <summary>
            ...
            <returns>The sine of <c>theta</c>.</returns>
        */
        ...
        /** <summary>
            ...
            <param name="theta">The angle in radians.</param>
            <returns>The cosine of <c>theta</c>.</returns>
        */
        ...
        /** <summary>
            ...
            <param name="theta">The angle in radians.</param>
            <returns>The tangent of <c>theta</c>.</returns>
        */
        ...
        //--------------------------------------------------------------------------
        /** <summary>
            Returns the arccosine (inverse cosine) of the specified value.
            </summary>
            <param name="value">A number in the range [-1, 1].</param>
            <returns>An angle in radians, in the range [0, π].</returns>
        */
        ...
        /** <summary>
            ...
            <param name="value">A number in the range [-1, 1].</param>
            <returns>An angle in radians, in the range [-π/2, π/2].</returns>
        */
        ...
        //--------------------------------------------------------------------------
        /** <summary>
            Returns the arctangent (inverse tangent) of the specified value.
            </summary>
