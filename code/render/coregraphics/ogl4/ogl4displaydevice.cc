...
namespace OpenGL4
{
__ImplementClass(OpenGL4::OGL4DisplayDevice, 'O4WD', Win32::Win32DisplayDevice);
__ImplementSingleton(OpenGL4::OGL4DisplayDevice);
...
/**
*/
OGL4DisplayDevice::OGL4DisplayDevice() 	
{
...
*/
bool
OGL4DisplayDevice::AdapterExists(Adapter::Code adapter)
{
...
OGL4DisplayDevice::GetAvailableDisplayModes(Adapter::Code adapter, PixelFormat::Code pixelFormat)
{
...
*/
bool
OGL4DisplayDevice::SupportsDisplayMode(Adapter::Code adapter, const DisplayMode& requestedMode)
{
...
*/
DisplayMode
OGL4DisplayDevice::GetCurrentAdapterDisplayMode(Adapter::Code adapter)
{
    n_assert(this->AdapterExists(adapter));
...
*/
AdapterInfo
OGL4DisplayDevice::GetAdapterInfo(Adapter::Code adapter)
{
    n_assert(this->AdapterExists(adapter));
...
*/
DisplayMode
OGL4DisplayDevice::ComputeAdjustedWindowRect()
{
