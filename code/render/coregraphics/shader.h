...
const ConstantBufferId ShaderCreateConstantBuffer(const ShaderId id, const Util::StringAtom& name, BufferUpdateMode mode = BufferUpdateMode::HostMapped);
/// create constant buffer from index
const ConstantBufferId ShaderCreateConstantBuffer(const ShaderId id, const IndexT cbIndex, BufferUpdateMode mode = BufferUpdateMode::HostMapped);
