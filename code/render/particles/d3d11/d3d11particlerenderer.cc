...
{
__ImplementClass(Direct3D11::D3D11ParticleRenderer, 'D1PR', Base::ParticleRendererBase);
__ImplementSingleton(Direct3D11::D3D11ParticleRenderer);
...
/**
*/
D3D11ParticleRenderer::D3D11ParticleRenderer() :
...
D3D11ParticleRenderer::Setup()
{
	...
	// set assign for particle meshes
	IO::AssignRegistry::Instance()->SetAssign(IO::Assign("parmsh", "export:meshes"));
    ...
    {
        n_error("D3D11ParticleRenderer: Failed to setup corner vertex buffer!");
    }
    ...
    {
        n_error("D3D11ParticleRenderer: Failed to setup corner index buffer!");
    }
    ...
    {
        n_error("D3D11ParticleRenderer: Failed to setup particle vertex buffer!");
    }
...
*/
void
D3D11ParticleRenderer::BeginAttach()
{
...
*/
void
D3D11ParticleRenderer::EndAttach()
{
    n_assert(this->inAttach);
    n_assert(0 != this->mappedVertices);
    this->inAttach = false;
