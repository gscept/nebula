...
__ImplementAbstractClass(Resources::ResourceMemoryCache, 'RMLO', Resources::ResourceCache);
//------------------------------------------------------------------------------
/**
*/
...
ResourceMemoryCache::ReserveResource(const ResourceName& res, const Util::StringAtom& tag)
{
    ResourceId ret;
...
*/
void
ResourceMemoryCache::DiscardResource(const Resources::ResourceId id)
{
...
*/
void
ResourceMemoryCache::DiscardByTag(const Util::StringAtom& tag)
{
    IndexT i;
