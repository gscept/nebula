...
ID_24_8_24_8_NAMED_TYPE(ResourceId, poolId, poolIndex, allocId, allocType);				// 24 bits: pool-resource id, 8 bits: pool id, 24 bits: allocator id, 8 bits: allocator type
