...
elseif(FIPS_MACOS)
    INCLUDE_DIRECTORIES(${FIPS_ROOT_DIR}/../sse2neon)
    SET(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -fpermissive -msse4.2 -march=armv8-a+fp+simd+crypto+crc -ffast-math -fPIC -fno-trapping-math -funsafe-math-optimizations -ffinite-math-only -mrecip=all -Wall")
    SET(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -msse4.2 -march=armv8-a+fp+simd+crypto+crc -ffast-math -fPIC -fno-trapping-math -funsafe-math-optimizations -ffinite-math-only -mrecip=all -Wall")
    set(CXX_WARNING_FLAGS "-Wno-sign-compare -Wno-unused-parameter -Wno-deprecated-copy -Wno-deprecated-volatile -Wno-unused-function -Wno-unknown-pragmas -Wno-ignored-pragmas -Wno-missing-braces -Wno-overloaded-virtual -Wno-unused-variable -Wno-tautological-constant-out-of-range-compare -w")
    set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -msse4 -mavx ${CXX_WARNING_FLAGS} ")
endif()
...
macro(nebula_project_material_template_compile)
...
macro(nebula_material_template_glue)
    ...
    set_target_properties(materialtemplates PROPERTIES FOLDER MaterialDefinitions)
    ...
    set_target_properties(materialinterface PROPERTIES FOLDER MaterialDefinitions)
