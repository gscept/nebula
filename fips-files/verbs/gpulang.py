"""Build and deploy gpulangcompiler
setup
"""
...
def run(fips_dir, proj_dir, args) :
    ...
    if sys.platform == "win32" :
        target = "gpulangcompiler-windows/gpulangcompiler.exe"
    else :
        target = "gpulangcompiler-linux/gpulangcompiler"
    if len(args) > 0 :
        noun = args[0]
        if noun == 'setup' :
            force = False
...
def help():
    ...
    log.info(log.YELLOW +
             ...
             "  Compiles GPULang compiler for platform\n")
