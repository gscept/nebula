...
/**
*/
CoreGraphics::VertexComponent::Format
AccessorTypeToNebula(Gltf::Accessor::ComponentType component, Gltf::Accessor::Type type)
{
    ...
    switch (type)
    {
        case Type::Scalar:
        {
            switch (component)
            {
                case Component::Float: return CoreGraphics::VertexComponent::Float;
                case Component::UnsignedShort: return CoreGraphics::VertexComponent::UShort;
            }
        }
        break;
        case Type::Vec2:
        {
            switch (component)
            {
                case Component::Float: return CoreGraphics::VertexComponent::Float2;
                case Component::Short: return CoreGraphics::VertexComponent::Short2;
            }
        }
        break;
        case Type::Vec3:
        {
            switch (component)
            {
                case Component::Float: return CoreGraphics::VertexComponent::Float3;
            }
        }
        break;
        case Type::Vec4:
        {
            switch (component)
            {
                case Component::Byte: return CoreGraphics::VertexComponent::Byte4;
                case Component::UnsignedByte: return CoreGraphics::VertexComponent::UByte4;
                case Component::Float: return CoreGraphics::VertexComponent::Float4;
                case Component::Short: return CoreGraphics::VertexComponent::Short4;
                case Component::UnsignedShort: return CoreGraphics::VertexComponent::UShort4;
            }
        }
        break;
        case Type::Mat2:
...
/**
*/
static CoreGraphics::VertexComponent::IndexName
AttributeToNebula(Gltf::Primitive::Attribute attr)
{
    switch (attr)
    {
        case Gltf::Primitive::Attribute::Position: return CoreGraphics::VertexComponent::Position;
        case Gltf::Primitive::Attribute::Normal: return CoreGraphics::VertexComponent::Normal;
        case Gltf::Primitive::Attribute::Tangent: return CoreGraphics::VertexComponent::Tangent;
        case Gltf::Primitive::Attribute::TexCoord0: return CoreGraphics::VertexComponent::TexCoord1;
        case Gltf::Primitive::Attribute::TexCoord1: return CoreGraphics::VertexComponent::TexCoord2;
        case Gltf::Primitive::Attribute::TexCoord2: return CoreGraphics::VertexComponent::TexCoord3;
        case Gltf::Primitive::Attribute::TexCoord3: return CoreGraphics::VertexComponent::TexCoord4;
        case Gltf::Primitive::Attribute::Color0: return CoreGraphics::VertexComponent::Color;
        case Gltf::Primitive::Attribute::Weights0: return CoreGraphics::VertexComponent::SkinWeights;
        case Gltf::Primitive::Attribute::Joints0: return CoreGraphics::VertexComponent::SkinJIndices;
        default:
            n_warning("Warning: Unhandled primitive attribute type\n");

    }
    return CoreGraphics::VertexComponent::Invalid;
}
