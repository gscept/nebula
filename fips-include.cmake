...
if(FIPS_WINDOWS)
	...
	SET(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} /arch:AVX /fp:fast /GS- /wd4838 /wd4244 /wd4996 ")
    ...
    if(N_DEBUG_SYMBOLS)
        ...
        set(CMAKE_EXE_LINKER_FLAGS_RELEASE "/DEBUG:fastlink")
    endif()
elseif(FIPS_LINUX)
...
FILE(GLOB_RECURSE PXFILES ${FIPS_DEPLOY_DIR}/physx/*)
